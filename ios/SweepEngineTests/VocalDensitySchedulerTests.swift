...
final class VocalDensitySchedulerTests: XCTestCase {
    ...
    func testListeningTestMixUsesAudibleBed() {
        XCTAssertEqual(SweepRendererSettings.listeningTest.staticGain, 0.0562, accuracy: 0.001)
        ...
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.vocalEventProbability, 0.07, accuracy: 0.000_1)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.clusteriness, 0.0, accuracy: 0.001)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.minVocalExposureSeconds, 0.100, accuracy: 0.000_1)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.maxVocalExposureSeconds, 0.180, accuracy: 0.000_1)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.minExposureFractionOfDwell, 0.40, accuracy: 0.000_1)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.maxExposureFractionOfDwell, 0.65, accuracy: 0.000_1)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.fadeSeconds, 0.015, accuracy: 0.000_1)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.recentExclusionWindow, 8)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.highPassHz, 500.0, accuracy: 0.001)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.lowPassHz, 3_600.0, accuracy: 0.001)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.gainVariation, 0.08, accuracy: 0.001)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.vocalPeakLimit, 0.65, accuracy: 0.001)
        XCTAssertEqual(SweepRendererSettings.listeningTestPreRebalance.scheduleAheadSeconds, 0.040, accuracy: 0.000_1)
    ...
    func testArchivedBaselinePresetStaysFrozenAndIsNotTheLiveDefault() {
        ...
        XCTAssertEqual(SweepRendererSettings.preset(identifier: "listening-test-pre-rebalance"), .listeningTestPreRebalance)
        XCTAssertNil(SweepRendererSettings.preset(identifier: "listening-test-gain-rebalance"))
        XCTAssertNil(SweepRendererSettings.preset(identifier: "pass-a-final"))
        XCTAssertNil(SweepRendererSettings.preset(identifier: "gain-rebalance"))
