...
final class VocalDensitySchedulerTests: XCTestCase {
    ...
    func testListeningTestMixUsesAudibleBed() {
        ...
        XCTAssertEqual(SweepRendererSettings.listeningTest.outputGain, 3.75, accuracy: 0.001)
    ...
    func testReadOnlyDiagnosticsMatchAppliedSettingsAndOmitForbiddenClaims() {
        ...
        XCTAssertEqual(SweepRendererSettings.listeningTestIdentity.version, "2026-09-10.bed-spectrum-v1")
